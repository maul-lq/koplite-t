...
<div class="box_keterangan">
    ...
    <table class="tbl_fm" style="border: 1px solid red; margin-left: 380px; padding: 5px;" width="350">
        <tr>
            ...
            <td>
                <?php
                if (isset($total_wajib) && $total_wajib->tot_wajib != 0) {
        ...
        <tr>
            ...
            <td>
                <?php
                if (isset($total_mdh) && $total_mdh->tot_mdh != 0) {
        ...
        <tr>
            ...
            <td>
                <?php
                $alltotal = isset($total_wajib) ? $total_wajib->tot_wajib : 0;
                $alltotal += isset($total_mdh) ? $total_mdh->tot_mdh : 0;
                if ($alltotal != 0) {
        ...
        <tr class="font_16" style="color:brown;">
            ...
            <td>
                <?php
                if (isset($total_simpanan) && $total_simpanan->total != 0) {
